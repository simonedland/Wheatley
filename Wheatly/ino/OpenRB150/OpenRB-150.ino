...
const bool  USE_MANUAL_LIMITS[NUM_SERVOS] = {false,true,true,false,false,true,false};
const float MANUAL_MIN[NUM_SERVOS]        = {0,180,140,0,0,-60,0};
const float MANUAL_MAX[NUM_SERVOS]        = {0,220,180,0,0, 60,0};
