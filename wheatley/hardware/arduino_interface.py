...
class ServoController:
    ...
    def __init__(self, servo_count=10):
        ...
        self.emotion_animations = {
            "angry": {"velocities": [20,10,10,10,10,5,5,20,5,1],"target_factors": [0.064,0.25,0.7,0.489,0.5,0.0,0.0,0.867,0.743,0.487],"idle_ranges": [40,2,2,5,5,10,10,2,5,10],"intervals": [2000,2000,2000,5000,2000,2000,2000,4000,4000,4000],"color": [255,0,0]},
            "happy": {"velocities": [5,2,1,2,2,5,5,1,1,1],"target_factors": [1.0,0.075,0.0,0.489,0.0,0.0,0.0,0.8,0.757,0.475],"idle_ranges": [40,2,1,30,5,10,10,10,15,10],"intervals": [1000,1000,2000,1000,1000,2000,2000,1000,1000,4000],"color": [0,255,0]},
            "sad": {"velocities": [5,1,1,1,1,5,5,1,1,1],"target_factors": [1.0,1.0,0.825,0.489,1.0,0.0,0.0,0.867,0.129,0.5],"idle_ranges": [10,10,10,40,5,10,10,10,5,20],"intervals": [2000,2000,2000,5000,2000,2000,2000,4000,4000,4000],"color": [0,0,255]},
            "neutral": {"velocities": [2,1,1,2,2,5,5,1,1,1],"target_factors": [0.504,1.0,0.0,0.489,0.5,0.0,0.0,0.8,0.771,0.487],"idle_ranges": [300,10,10,10,5,10,10,10,15,10],"intervals": [10000,5000,5000,5000,5000,2000,2000,2000,2000,4000],"color": [255,255,255]},
            "excited": {"velocities": [5,10,10,10,10,5,5,10,2,1],"target_factors": [0.497,1.0,0.0,0.489,0.429,0.0,0.0,0.9,0.7,0.45],"idle_ranges": [10,10,10,10,10,10,10,10,10,5],"intervals": [2000,2000,2000,5000,2000,2000,2000,1000,1000,4000],"color": [255,128,0]},
            "confused": {"velocities": [5,5,5,5,5,5,5,1,2,1],"target_factors": [0.5,1.0,0.0,0.5,0.5,0.0,0.0,0.5,0.829,0.0],"idle_ranges": [400,10,10,40,35,10,10,15,10,4],"intervals": [2000,2000,2000,2000,2000,2000,2000,2000,2000,2000],"color": [128,255,255]},
            "surprised": {"velocities": [20,20,20,10,10,5,5,10,2,1],"target_factors": [1.0,1.0,0.0,0.5,0.5,0.0,0.0,0.7,1.0,0.5],"idle_ranges": [10,1,1,10,10,10,10,10,10,5],"intervals": [1000,1000,1000,500,500,2000,2000,1000,1000,4000],"color": [255,255,0]},
            "curious": {"velocities": [10,1,1,5,1,1,1,5,1,1],"target_factors": [0.0,0.375,0.25,0.5,0.0,0.0,0.0,0.5,0.843,0.475],"idle_ranges": [100,5,5,50,10,10,10,35,2,30],"intervals": [5000,2000,2000,2000,10400,10500,10600,2000,1000,2000],"color": [255,128,0]},
            "bored": {"velocities": [5,1,1,1,1,1,1,1,1,1],"target_factors": [0.0,1.0,0.825,0.5,0.0,0.0,0.0,0.511,0.5,0.45],"idle_ranges": [100,5,5,20,10,10,10,40,30,0],"intervals": [5000,5000,5000,2000,10400,10500,10600,10000,10000,10000],"color": [128,0,255]},
            "fearful": {"velocities": [10,3,3,10,10,1,1,5,2,1],"target_factors": [0.0,1.0,0.0,0.5,0.486,0.0,0.0,0.5,0.743,0.512],"idle_ranges": [100,2,2,40,30,10,10,35,5,20],"intervals": [1000,1000,1000,1000,1000,10500,10600,2000,2000,5000],"color": [255,0,0]},
            "hopeful": {"velocities": [20,1,1,10,1,1,1,5,1,1],"target_factors": [0.0,0.475,0.075,0.5,0.0,0.0,0.0,0.5,0.75,0.5],"idle_ranges": [200,5,3,50,10,10,10,20,4,0],"intervals": [5000,1000,1000,500,10400,10500,10600,1000,1000,10000],"color": [128,128,255]},
            "embarrassed": {"velocities": [2,5,5,5,5,5,5,1,1,1],"target_factors": [1.0,0.0,0.0,0.5,0.0,0.0,0.0,0.767,0.843,0.55],"idle_ranges": [10,10,10,40,10,10,10,10,10,30],"intervals": [2000,2000,2000,500,2000,2000,2000,1000,10000,3000],"color": [255,0,255]},
            "frustrated": {"velocities": [5,1,1,5,1,1,1,1,1,1],"target_factors": [0.032,0.25,0.75,0.5,0.5,0.0,0.0,0.733,0.829,0.5],"idle_ranges": [10,5,3,10,10,10,10,10,5,5],"intervals": [5000,1000,1000,1000,1000,1000,1000,5000,3000,3000],"color": [255,0,0]},
            "proud": {"velocities": [10,1,1,10,1,5,5,1,1,1],"target_factors": [0.865,0.15,0.0,0.489,0.043,0.0,0.0,0.7,1.0,0.5],"idle_ranges": [100,5,1,40,3,10,10,15,1,1],"intervals": [2000,1000,5000,3000,5000,2000,2000,2000,3000,4000],"color": [255,255,0]},
            "nostalgic": {"velocities": [10,1,1,5,1,1,1,1,1,1],"target_factors": [0.865,0.375,0.25,0.5,0.0,0.0,0.0,0.733,0.829,0.512],"idle_ranges": [100,5,5,50,10,10,10,7,5,40],"intervals": [5000,1000,1000,2000,10400,10500,10600,5000,1000,2000],"color": [0,0,64]},
            "relieved": {"velocities": [10,1,1,10,1,5,5,3,1,1],"target_factors": [0.865,0.15,0.0,0.489,0.043,0.0,0.0,0.733,0.857,0.487],"idle_ranges": [100,5,1,40,3,10,10,7,3,20],"intervals": [2000,1000,5000,3000,5000,2000,2000,1000,3000,5000],"color": [0,0,160]},
            "grateful": {"velocities": [10,1,1,10,1,5,5,1,1,1],"target_factors": [0.865,0.15,0.0,0.489,0.043,0.0,0.0,0.533,0.829,0.5],"idle_ranges": [100,5,1,40,3,10,10,10,10,15],"intervals": [2000,1000,5000,3000,5000,2000,2000,5000,3000,10000],"color": [0,255,255]},
            "shy": {"velocities": [5,1,1,5,1,1,1,2,1,1],"target_factors": [0.489,1.0,0.0,0.5,0.0,0.0,0.0,0.767,1.0,0.5],"idle_ranges": [300,5,3,50,10,10,10,7,3,20],"intervals": [5000,1000,1000,1000,10400,10500,10600,3000,3000,5000],"color": [255,0,255]},
            "disappointed": {"velocities": [2,1,1,1,1,1,1,1,1,1],"target_factors": [0.449,1.0,0.8,0.5,0.529,0.0,0.0,0.7,0.857,0.5],"idle_ranges": [100,5,5,20,10,10,10,7,7,1],"intervals": [5000,1000,1000,2000,1000,1000,1000,1000,7000,1000],"color": [255,255,0]},
            "jealous": {"velocities": [2,10,10,5,5,5,5,3,3,1],"target_factors": [0.0,0.325,0.625,0.489,0.486,0.0,0.0,0.5,0.857,0.5],"idle_ranges": [100,2,2,40,3,10,10,10,5,20],"intervals": [2000,5000,5000,5000,5000,2000,2000,2000,2000,4000],"color": [128,0,255]}
            }
